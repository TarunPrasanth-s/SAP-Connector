    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 space-y-3">
        ...
        <p className="text-xs text-gray-500">
          {downloaded
            ? 'Right-click the downloaded .bat file → "Run as Administrator". It installs JDK, extracts Cloud Connector, and starts it — no other action needed.'
...
// MAIN COMPONENT
// ══════════════════════════════════════════════════════════════════════════
export default function TargetSystemSetup() {
  ...
  // Reset CC state when backend type changes
  useEffect(() => {
    setHasCC(null);
    setSetupDone(false);
  }, [bt]);
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="w-full max-w-xl space-y-3">
        ...
        <div className="mb-6 text-center">
          <h1 className="text-base font-bold text-gray-900">Target System Configuration</h1>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm divide-y divide-gray-100">
          {/* ① Back-end Type */}
          <div className="p-6">
            <SectionHeader title="Back-end Type" description="Select the type of SAP system you are connecting to." />
